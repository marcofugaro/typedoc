...
describe('Array utils', () => {
    describe('insertPrioritySorted', () => {
        ...
        it('inserts in the middle', () => {
            assert_1.deepStrictEqual(array_1.insertPrioritySorted([item1, item3], item2), [item1, item2, item3]);
        });
        it('inserts at the end', () => {
            assert_1.deepStrictEqual(array_1.insertPrioritySorted([item2, item3], item4), [item2, item3, item4]);
        });
    ...
    describe('binaryFindPartition', () => {
        ...
        it('works with no partition', () => {
            assert_1.deepStrictEqual(array_1.binaryFindPartition([1, 2, 3], n => false), -1);
        });
